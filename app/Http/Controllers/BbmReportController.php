...
class BbmReportController extends Controller
{
    ...
    public function store(Request $request): RedirectResponse|JsonResponse
    {
        ...
        $validated = $request->validate([
            ...
            'odometer_sebelum' => ['required', 'numeric', 'min:0'],
            'odometer_sesudah' => ['required', 'numeric', 'min:0', 'gte:odometer_sebelum'],
            ...
            'odometer_sebelum.numeric' => 'KM sebelum harus berupa angka.',
            'odometer_sebelum.min' => 'KM sebelum tidak boleh negatif.',
            'odometer_sesudah.required' => 'KM odometer sesudah wajib diisi.',
            'odometer_sesudah.numeric' => 'KM sesudah harus berupa angka.',
        ...
        try {
            BbmReport::create([
                ...
                'odometer_sebelum' => $validated['odometer_sebelum'],

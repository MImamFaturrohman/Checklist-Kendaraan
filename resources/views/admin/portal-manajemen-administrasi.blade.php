        ...
        <tr id="krow-${k.id}">
            ...
            <td class="text-center">
                <div class="mgmt-actions">
                    ...
                    <form id="kdel-${k.id}" action="${armadaUpdateUrl(k.id)}" method="POST" style="display:contents" onsubmit="event.preventDefault();deleteKendaraan(${k.id},'${escJs(k.nomor_kendaraan)}')">

...
<body class="dash-body">
    ...
    @include('partials.premium-dash-bg', ['premiumBgId' => 'portal_pemeriksaan'])
        ...
        <div class="dash-nav-inner">
            ...
            <div class="dash-nav-actions" id="dash-nav-actions">
                ...
                <span class="dash-chip {{ ($pemeriksaanInsightOnlyManager ?? false) ? 'dash-chip-manager' : 'dash-chip-admin' }}">
                    ...
                    <span class="dash-nav-chip-label">{{ ($pemeriksaanInsightOnlyManager ?? false) ? 'MANAGER' : 'SUPERADMIN' }}</span>
                </span>

...
<form method="GET" action="{{ route($route) }}" class="admin-toolbar" id="admin-toolbar">
    {{-- Search --}}
    <div class="admin-search-wrap">
        ...
        <input type="text" name="search" value="{{ request('search') }}" placeholder="Cari nopol, driver, jenis..." class="admin-search-input" id="admin-search-input">
        @if(request('search'))
    ...
    <div class="admin-filter-row">
        ...
        <div class="admin-filter-item">
            <label>Dari</label>
            <input type="date" name="tanggal_dari" value="{{ request('tanggal_dari') }}" class="admin-filter-input">
        </div>
        <div class="admin-filter-item">
            <label>Sampai</label>
            <input type="date" name="tanggal_sampai" value="{{ request('tanggal_sampai') }}" class="admin-filter-input">
        </div>
        @endif
        ...
        <div class="admin-filter-item">
            <label>Nopol</label>
            <select name="nopol" class="admin-filter-input">
        ...
        <div class="admin-filter-item">
            <label>Shift</label>
            <select name="shift" class="admin-filter-input">
                <option value="">Semua</option>

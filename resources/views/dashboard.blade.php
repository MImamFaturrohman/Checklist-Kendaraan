        ...
        <div class="dash-shell">
            <section class="dash-top">
                ...
                <div class="dash-hero">
                    ...
                    {{-- Widget jam/tanggal/shift — hanya untuk driver --}}
                    @if($isDriver)
            ...
            <main class="dash-content">
                <div class="dash-desktop-grid">
                    ...
                    <div class="dash-main-column">
                        ...
                        @elseif($isAdmin)
                            {{-- Admin: Portal Pemeriksaan first, then Ceklist --}}
                            <section>
                                <h3 class="dash-section-title">TUGAS UTAMA</h3>
                                <a href="{{ route('admin.portal-pemeriksaan') }}" class="dash-main-card dash-pressable" style="margin-bottom:12px">
                                    <div>
                                        <p class="dash-main-title">Portal Pemeriksaan Kendaraan</p>
                                        <p class="dash-main-sub">Database, foto fisik &amp; arsip PDF dalam satu tempat</p>
                                    </div>
        ...
        (function () {
            ...
            function tick() {
                ...
                document.getElementById('dash-clock-date').textContent =
                    `${day}, ${date} ${month} ${year}`;
                document.getElementById('dash-clock-time').textContent =
                    `${hh}:${mm}:${ss}`;

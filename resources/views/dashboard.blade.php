                            ...
                            <section>
                                ...
                                <div class="dash-main-grid-admin">
                                    ...
                                    <a href="{{ route('admin.laporan-kejadian.index') }}" class="dash-main-card dash-pressable">
                                        ...
                                        <span class="dash-main-icon" aria-hidden="true">
                                            <svg width="32" height="32" viewBox="0 0 24 24" fill="none" aria-hidden="true"><path d="M12 9v4M12 17h.01M10.29 3.86L1.82 18a2 2 0 001.71 3h16.94a2 2 0 001.71-3L13.71 3.86a2 2 0 00-3.42 0z" stroke="currentColor" stroke-width="2" stroke-linecap="round"/></svg>
                                        </span>
                                    </a>
